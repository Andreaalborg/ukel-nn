...
export default function TasksPage() {
  ...
  const save = async () => {
    ...
    const payload = {
      ...
      duration_minutes: Math.max(5, editing.duration_minutes || 15),
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <div className="flex items-center gap-1">
            <input
              ...
              className="w-16 px-2 py-2 rounded-xl border-2 border-purple-200 focus:border-purple-500 outline-none text-center"
            />
            <span className="text-xs text-purple-500 font-semibold">min</span>
          </div>
          {draft.due_time && (
            <button
              type="button"
        ...
        <p className="text-xs text-purple-400 mb-3">
          Brukes i familiekalenderen (Dagsplan). Varighet er 15 min som standard.
        </p>
